#Usando una jerarquía de clases que permita calcular el área y el perímetro de Rectángulo,
#  Triángulo y Círculo. Crear una lista con un objeto de cada figura y mostrar sus datos
